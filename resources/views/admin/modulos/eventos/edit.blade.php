...
@section('custom-css')
  <link href="{{asset('/public/plugins/formstep/wizard.css')}}" rel="stylesheet" type="text/css" />
...
@section('custom-js')
  ...
  {{-- Custom --}}
  <script type="text/javascript" src="{{asset('/public/js/modulos/eventos/edit.js')}}"></script>
